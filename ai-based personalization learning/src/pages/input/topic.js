...
const TopicPage = (props) => {
  ...
  const [timeUnit] = useState("Weeks"); // ✅ fixed to Weeks only
      ...
      <div className="inputContainer TopicInput">
        ...
        <input
          ...
          onChange={(e) => {
            ...
            setIcon(e.target.value ? arrowIcon : searchIcon);
          }}
        />
        <button
          onClick={(e) => {
            e.preventDefault();
            if (inputVal) setTopic(inputVal);
          }}
        >
          {icon}
        </button>
  ...
  const SetDetails = () => (
    <div className="flexbox main setDetails">
      ...
      <TimeInput />
      <h2 style={{ marginTop: "1.5em" }}>Your Knowledge Level on the Topic</h2>
      <KnowledgeLevelInput />
